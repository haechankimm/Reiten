...
values
  ('reflect-heart-hoodie', 'Reflect Heart Hoodie', '리플렉트 하트 후디', 'hoodie', '후드티', 89000, 'Reflective',
   '["assets/img/hoodie-heart.webp","assets/img/hoodie-heart-khaki.webp","assets/img/hoodie-heart-yellow.webp"]',
   '["black","khaki","yellow","sky"]', '["S","M","L","XL"]', '[]', 'hoodie',
  ...
  ('reflect-exhaust-hoodie', 'Reflect Exhaust Hoodie', '리플렉트 이그저스트 후디', 'hoodie', '후드티', 89000, 'Reflective',
   '["assets/img/hoodie-exhaust.webp","assets/img/hoodie-exhaust-yellow.webp"]',
   '["black","yellow"]', '["S","M","L","XL"]', '["S"]', 'hoodie',
  ...
  ('helmet-zip-hoodie', 'Helmet Zip Hoodie', '헬멧 집업 후디', 'zip', '후드집업', 129000, 'Washed',
   '["assets/img/zip-charcoal.webp",null]',
   '["charcoal"]', '["S","M","L","XL"]', '[]', 'hoodie',
   '가먼트 워싱 · 프론트 드로잉 그래픽',
  ...
  ('core-zip-hoodie', 'Core Zip Hoodie', '코어 집업 후디', 'zip', '후드집업', 119000, 'Customizable',
   '["assets/img/zip-blue.webp","assets/img/zip-green.webp",null]',
   '["black","cream","sky","forest","charcoal","clay"]', '["S","M","L","XL"]', '[]', 'hoodie',
   '6컬러 · 지퍼 참 커스텀 가능',
  ...
  ('reflect-crop-hoodie', 'Reflect Crop Zip Hoodie', '리플렉트 크롭 집업 후디', 'crop', '크롭 후드티', 89000, 'Customizable',
   '["assets/img/crop-forest.webp",null]',
   '["black","cream","clay","forest"]', '["S","M","L"]', '[]', 'crop',
