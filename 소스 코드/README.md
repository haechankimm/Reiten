...
| **사업자 정보** | `assets/js/data.js`의 `SITE.biz` 전부 채움(상호 Reiten · 대표 김해찬 · 사업자등록번호 154-44-01222 · 통신판매업신고 제-2026-용인기흥-00638 호 · 주소 · 전화번호 010-9399-6861). **인스타그램 계정(`reiten_korea`) 반영 완료**(2026-08-13, 푸터에 실제 프로필로 연결되는 링크로 노출). `SITE.order.kakao`(카카오톡 채널)는 아직 자리표시자라 채널 개설 전까지 푸터에서 자동으로 숨김 처리됨(`app.js`의 `renderFooter()` — `[`로 시작하는 값은 안 보여줌) |
...
**오픈 전 확인**
- `SITE.order.kakao` 자리표시자 교체 (카카오톡 채널 개설 후 — 인스타그램은 2026-08-13에 완료)
...
| 카카오톡 채널 · 인스타그램 계정 | 인스타그램 ✅ 완료(`reiten_korea`, 2026-08-13). 카카오톡 ❌ 미완료 — `SITE.order.kakao` 아직 자리표시자(채널 개설 후 교체 필요, 그 전까지는 푸터에서 자동으로 숨겨짐) |
...
- [ ] `data.js`의 `SITE.order.kakao` 자리표시자 교체(카카오톡 채널 개설 후)
