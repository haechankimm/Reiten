...
const COLORS = {
  ...
  charcoal: { key: "charcoal", label: "워시드 차콜", hex: "#4a4a4c" },
  cream:    { key: "cream",    label: "크림",        hex: "#e8e2d4" },
  sky:      { key: "sky",      label: "스카이 블루", hex: "#9dbdd8" },
  forest:   { key: "forest",   label: "포레스트",    hex: "#2b5347" },
  clay:     { key: "clay",     label: "클레이",      hex: "#b08574" },
  khaki:    { key: "khaki",    label: "워시드 카키", hex: "#6d6d65" },
  yellow:   { key: "yellow",   label: "머스타드 옐로우", hex: "#edd58f" },
};
...
const PRODUCTS = [
  {
    ...
    badge: "Reflective",
    images: [
      "assets/img/hoodie-heart.webp",
      "assets/img/hoodie-heart-khaki.webp",
      "assets/img/hoodie-heart-yellow.webp",
    ],
    colors: ["black", "khaki", "yellow", "sky"],
    sizes: ["S", "M", "L", "XL"],
    soldOut: [],
    sizeTable: "hoodie",
  ...
  },
  {
    ...
    price: 89000,
    badge: "Reflective",
    images: ["assets/img/hoodie-exhaust.webp", "assets/img/hoodie-exhaust-yellow.webp"],
    colors: ["black", "yellow"],
    sizes: ["S", "M", "L", "XL"],
    soldOut: ["S"],
    sizeTable: "hoodie",
  ...
  },
  {
    ...
    price: 129000,
    badge: "Washed",
    images: ["assets/img/zip-charcoal.webp", null],
    colors: ["charcoal"],
    sizes: ["S", "M", "L", "XL"],
    soldOut: [],
    sizeTable: "hoodie",
  ...
  },
  {
    ...
    price: 119000,
    badge: "Customizable",
    images: ["assets/img/zip-blue.webp", "assets/img/zip-green.webp", null],
    colors: ["black", "cream", "sky", "forest", "charcoal", "clay"],
    sizes: ["S", "M", "L", "XL"],
    soldOut: [],
    sizeTable: "hoodie",
  ...
  },
  {
    ...
    price: 89000,
    badge: "Customizable",
    images: ["assets/img/crop-forest.webp", null],
    colors: ["black", "cream", "clay", "forest"],
    sizes: ["S", "M", "L"],
    soldOut: [],
    sizeTable: "crop",
