...
const I18N = {
  ...
  "{name}님, 좋은 아침이에요 — 오늘은 조용하네요.": { de: "Guten Morgen, {name} — heute ist es ruhig." },
  "{name}님, 좋은 아침이에요 — 확인할 게 {n}건 있어요.": { de: "Guten Morgen, {name} — {n} Dinge warten auf Prüfung." },
  "{name}님, 순조롭게 흘러가는 오후예요.": { de: "Ein reibungsloser Nachmittag, {name}." },
  "{name}님, 오후에도 확인할 게 {n}건 남아있어요.": { de: "{name}, am Nachmittag warten noch {n} Dinge auf Prüfung." },
